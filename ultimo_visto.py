...
Controle local (arquivo JSON) do ultimo processo capturado por
tribunal/classe/valor de busca. Elimina a necessidade de consultar o
Firestore para verificar duplicidade: como cada combinacao e lida do mais
recente para o mais antigo, basta comparar o numero do processo mais
recente da lista com o ultimo que ja foi capturado.
...
class UltimoVisto:
    ...
    def _com_lock(self, func):
        # Varios bots (PJe, eproc RJ/RS, eproc SC, eproc SP) podem rodar em
        # paralelo e escrever no mesmo arquivo -- o filelock evita corrida
        # entre eles. Tribunais/chaves diferentes sao chaves diferentes no
        # mesmo JSON, entao o lock so protege a escrita/leitura do arquivo,
        # nao os dados em si.
        if _TEM_FILELOCK:
